import cv2
import os
from Preparing_data.gather_data import DEFAULT_TOWN
"""
...
loading_directory = 'data/debug/' + DEFAULT_TOWN
ext = '.jpg'
output = 'data/debug/' + DEFAULT_TOWN + '.mp4' # Save output file in lanedetection/data/
