...
loading_directory = cfg.LOAD_DIR
saving_directory = cfg.SAVE_DIR
...
class ImageSaver():
    ...
    def execute(self):
        ...
        self.label_loader2 = LabelLoader(cfg.TRAIN_GT, cfg.OVERALL_GT)
        self.image_name = 0
    ...
    def save_image_to_disk(self, image_array):
        ...
        save_name = saving_directory + str(self.label_loader2.calculate_folder(cfg.HEIGHT_SAMPLES))
    ...
    def save_images_with_lanepoints(self, image_array):
        ...
        save_name = os.path.join('data/debug/', f'{cfg.DEFAULT_TOWN}/{self.image_name_gt:04d}')
